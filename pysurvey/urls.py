...
urlpatterns = [
    ...
    url(r'^studenti/(?P<id>[0-9]+)/$', jobsurvey.views.Studenti.as_view(), name='studenti_modifica'),
    ...
    url(r'^aziende/(?P<id>[0-9]+)/$', jobsurvey.views.Aziende.as_view(),name='aziende_modifica'),
    ...
    url(r'^lavori/(?P<id>[0-9]+)/$', jobsurvey.views.Lavori.as_view(), name='lavori'),
