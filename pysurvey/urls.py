...
urlpatterns = [
    ...
    url(r'^changepassword/$', createSurvey.views.Change_password.as_view(), name="change_password"),
    url(r'^resetpassword/(?P<id>[0-9]+)/(?P<str>.*)/$', createSurvey.views.Reset_password.as_view(), name="reset_password"),
    url(r'^lostpassword/$', createSurvey.views.Lost_password.as_view(), name="lost_password"),
    ...
    url(r'^raccomanda/lavoro/(?P<id>[0-9]+)/$', jobsurvey.views.ColdStartStudente.as_view(), name='cold_start_std'),
    url(r'^raccomanda/studente/(?P<id>[0-9]+)/$', jobsurvey.views.ColdStartLavoro.as_view(), name='cold_start_std_lavoro'),
